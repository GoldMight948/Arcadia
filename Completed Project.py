...
while arcade :
        ...
        if choice == 1 :
            ...
            while RPS:
                ...
                print("/nWell see you later then",Username)
            ...
            while r:
                ...
                roulette = {'00':'Green',0:'Green',1:'Red',2:'Black',3:'Red',4:'Black',5:'Red',6:'Black',7:'Red',
                ...
                if choice == 5:
                    print("On which colume you wanna bet on ?")
                    for i in range(12):
                        if i < 9:
