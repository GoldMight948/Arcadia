...
while arcade :
        ...
        print("\nWhich Game You want to Play \tgolden_drachma:",golden_drachma,"\tStamina: ",stam,"\n 1. Roll The Dice \n 2. Rock Paper Scissors \n 3. Roulette \n 4. Blackjack \n 5. Shop \n 6. Leave")
        try:
        ...
        if choice == 1 :
            ...
            while q:
                ...
                if x == 'yes':
                    ...
                    continue
                try:                 
                    bet = int(input("How much you want to bet on your Win?: "))
                except ValueError:
            ...
            while r:
                ...
                if x == 'yes':
                    ...
                    print("please enter valid input!")
                    continue
                bet = int(input("Amount of money you want to bet: "))
                ...
                if choice == 1:
                    print("On which number you want to place you bet from 1-36?")
                    try:
                ...
                if choice == 2:
                    print("On which color you want to place your bet\n1.Red\n2.Black")
                    try:
                ...
                if choice == 3:
                    print("On which do you want to make your bet \n1.Odd\n2.Even")
                    try:
                        bets = int(input("Enter Your Choice: "))
                    except ValueError:
                        print("Please enter a valid input")
                ...
                if choice == 5:
                    print("On which column do you want to bet on ?")
                    for i in range(12):
                        if i < 9:
                ...
                if choice == 6:
                    print("On which range you want to place your bet?\n1.1st range [1-18]\n2.2nd range [19-36]")
                    try:
                        bets = int(input("Enter Your Choice: "))
                    except ValueError:
                        print("Please enter a valid input")
            ...
            while shop :
                ...
                order = int(input("Which Item You want to Buy:"))
